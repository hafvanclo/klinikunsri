...
public class DoctorSpecialisAdapter extends RecyclerView.Adapter<DoctorSpecialisAdapter.DoctorViewHolder> {

    private List<DoctorSpesialis> doctorList;
    private OnDoctorClickListener listener;

    // Constructor
    public DoctorSpecialisAdapter(List<DoctorSpesialis> doctorList, OnDoctorClickListener listener) {
    ...
    public DoctorViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.doctor_spesialis_item, parent, false);
        return new DoctorViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull DoctorViewHolder holder, int position) {
        DoctorSpesialis doctor = doctorList.get(position);
    ...
    public interface OnDoctorClickListener {
        void onDoctorClick(DoctorSpesialis doctor);
    }
}
